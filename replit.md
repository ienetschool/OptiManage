...
- **August 17, 2025 - PATIENT DROPDOWN ISSUE COMPLETELY RESOLVED**: ✅ **SELECTITEM VALIDATION ERROR FIXED** - Root cause identified: disabled SelectItem with value "no-patients" was triggering validation errors. Replaced disabled SelectItem with simple div element for "no patients" message. MySQL database confirmed working correctly with camelCase field names. Fixed both development and production servers. Patient dropdown now working without validation errors in appointment forms.
